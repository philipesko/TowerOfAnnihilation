...
class Creep_green_1(Creep):
    ...
    def __init__(self):
        ...
        self.reward = 10
        # Creep level 2
        self.creep_imgs = [self.load_image('creep-1-green/1.png'),
...
class Creep_red_1(Creep):
    ...
    def __init__(self):
        ...
        self.reward = 15
        # Creep level 3
        self.creep_imgs = [self.load_image('creep-1-red/1.png'),
...
class Creep_blue_2(Creep):
    ...
    def __init__(self):
        ...
        self.reward = 20
        # Creep level 4
        self.creep_imgs = [self.load_image('creep-2-blue/1.png'),
...
class Creep_green_2(Creep):
    ...
    def __init__(self):
        ...
        self.reward = 25
        # Creep level 4
        self.creep_imgs = [self.load_image('creep-2-green/1.png'),
...
class Creep_red_2(Creep):
    ...
    def __init__(self):
        ...
        self.reward = 30
        # Creep level 4
        self.creep_imgs = [self.load_image('creep-2-red/1.png'),
...
class Creep_blue_3(Creep):
    ...
    def __init__(self):
        ...
        self.reward = 35
        # Creep level 4
        self.creep_imgs = [self.load_image('creep-3-blue/1.png'),
...
class Creep_green_3(Creep):
    ...
    def __init__(self):
        ...
        self.reward = 40
        # Creep level 4
        self.creep_imgs = [self.load_image('creep-3-green/1.png'),
...
class Creep_red_3(Creep):
    ...
    def __init__(self):
        ...
        self.reward = 45
        # Creep level 4
        self.creep_imgs = [self.load_image('creep-3-red/1.png'),
...
class Boss(Creep):
    ...
    def __init__(self):
        ...
        self.reward = 100
        # Boss
        self.creep_imgs = [self.load_image('boss/boss-1.png'),
